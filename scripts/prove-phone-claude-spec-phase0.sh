...
require "$MAIN" 'toolbarNavigationButton("Tools"' "APK toolbar must expose Tools for secondary recovery actions"
require "$MAIN" 'refreshTerminalTransport();' "APK Tools must keep Refresh reachable"
require "$MAIN" 'showViewControls();' "APK Tools must keep Scroll reachable"
